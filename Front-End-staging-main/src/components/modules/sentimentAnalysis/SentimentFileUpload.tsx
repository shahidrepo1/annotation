...
export default function SentimentFileUpload({
  file,
  onFileChange,
  errorMessage,
}: FileUploadProps) {
      ...
      >
        ...
        >
          ...
          <span className="text-center text-sm font-medium max-w-[220px] truncate">
            {file ? file.name : "Click to upload document, audio or video file"}
          </span>

          <input
            id="audio-upload"
            type="file"
            accept="audio/*, video/*, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document, application/pdf"
