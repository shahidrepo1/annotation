  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="mt-4 p-4 bg-white-100 rounded shadow">
        {activeTab === "ViewAll" && data && <FrViewAll data={data} />}
        {activeTab === "TrainedData" && data && <FrTrainedData data={data} />}
