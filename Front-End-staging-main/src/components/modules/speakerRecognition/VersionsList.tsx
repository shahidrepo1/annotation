...
import useGetSrTrainedData from "../../../api/useGetSrTrainedData";
import { SrTrainedDataObjectType } from "../../../api/useGetSrTrainedData.types";
import { CiSearch } from "react-icons/ci";

type VersionListProps = {
  onSelectVersion: (version: SrTrainedDataObjectType | null) => void;
};

export default function VersionList({ onSelectVersion }: VersionListProps) {
  const { data, isPending, isError } = useGetSrTrainedData();
