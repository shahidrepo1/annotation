...
import { ObjectDetectionTrainingFolders } from "./ObjectDetectionTrainingFolders";
export default function ObjectDetectionTrainingData({
  selectedVersion,
}: {
    ...
    <div className="p-6 bg-gray-100 overflow-y-auto">
      ...
      <div className="w-full space-x-3">
        <div className="bg-white p-6 shadow rounded m-3">
          ...
          <ObjectDetectionTrainingFolders data={selectedVersion} />
        </div>
      </div>
    </div>
  );
