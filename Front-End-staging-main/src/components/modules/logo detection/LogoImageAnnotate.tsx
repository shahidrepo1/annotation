...
import { LogoToolbar } from "./LogoImageAnnotateComponent/LogoToolbar";
import { LogoClasses } from "./LogoImageAnnotateComponent/LogoClasses";
import { LogoCanvasControls } from "./LogoImageAnnotateComponent/LogoCanvasControls";
...
export const LogoImageAnnotate = ({
  imageSrc,
  initialRectangles = [],
  onSaveAnnotation,
  onClose,
